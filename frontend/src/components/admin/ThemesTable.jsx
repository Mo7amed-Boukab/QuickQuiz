...
export default function ThemesTable({ themes, loading, error, onDelete, onEdit }) {
    ...
    if (error && themes.length === 0) return <div className="text-center py-4 text-red-500">{error}</div>;
                        ...
                        <tbody>
                            {filteredThemes.length > 0 ? (
                                filteredThemes.map((theme) => (
                                    <tr key={theme._id} className="border-b border-[#e5e5e5] last:border-0 hover:bg-[rgba(0,0,0,0.02)] transition-colors">

          ...
          <div className="mb-12">
            ...
            <div className="bg-white border border-[#e5e5e5] rounded overflow-hidden">
              {leaderboard.map((player) => (
                <div
                  key={player.rank}
                  className={`flex items-center gap-4 py-5 px-6 border-b border-[#e5e5e5] last:border-0 transition-colors hover:bg-[rgba(0,0,0,0.02)] ${
                    player.rank === 1
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-base flex-shrink-0 border-2 ${
                      player.rank === 1
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-base mb-1 text-[#1a1a1a]">
                      {player.name}
                    </div>
